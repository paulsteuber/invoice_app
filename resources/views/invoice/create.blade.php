                                    ...
                                    <div class="row">         
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{$user->profile->name}}" required >
                                                    @error('name')
                                        ...
                                        <div class="form-group col-md-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="street" type="text" class="form-control @error('street') is-invalid @enderror" name="street" value="{{$user->profile->street}}" required >
                                                    @error('street')
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                                        </span>
                        ...
                        <div class="col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input id="bank" type="text" class="form-control @error('bank') is-invalid @enderror" name="bank" value="{{$user->profile->bank}}" required >
                                            @error('bank')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                ...
                                <div class="form-group col-md-12">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <input id="tax_id" type="text" class="form-control @error('tax_id') is-invalid @enderror" name="tax_id" value="{{$user->profile->tax_id}}" >
                                            @error('tax_id')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                       ...
                                       <invoice-number-component next-invoice-number={{$nextInvoiceNumber}}></invoice-number-component> 
                                        ...
                                        <div class="form-group col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="invoice_description" type="text" class="form-control @error('invoice_description') is-invalid @enderror" name="invoice_description" placeholder="" required autocomplete="invoice_description">
                                    ...
                                    <div class="card-header"><h2 class="h5">{{__('Zahlungsinformationen')}}</h2></div>
                                        <div class="card-body row form-group">
                                            ...
                                            @error('invoice_partial_pay', 'invoice_partial_pay_date', 'invoice_partial_pay_sum', 'invoice_pay_date', 'invoice_state', 'invoice_additional')
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        ...
                                                        <select class="custom-select" id="invoice_state" name="invoice_state" required>
                                            ...
                                            <div class="col-lg-7">
                                                ...
                                                <div class="col-md-12">
                                                    <textarea id="invoice_additional" class="form-control @error('invoice_additional') is-invalid @enderror" name="invoice_additional" value="{{ old('invoice_additional')  }}" placeholder="{{'Weitere Informationen zu dieser Rechnung (z.B. Teilvorauszahlung)'}}"></textarea>
